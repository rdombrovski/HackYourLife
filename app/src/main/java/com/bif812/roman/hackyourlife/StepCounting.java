...
public class StepCounting extends Service implements SensorEventListener{
    ...
    public static final String BROADCAST_ACTION = "com.bif812.roman.mybroadcast";
    ...
    private void showNotification() {
        ...
        notif.setContentText("Pedometer session is running in the background.");
        notif.setSmallIcon(R.mipmap.ic_launcher);
        notif.setColor(Color.parseColor("#6600cc"));
        int colorLED = Color.argb(255, 0, 255, 0);
        notif.setLights(colorLED, 500, 500);
        // To  make sure that the Notification LED is triggered.
        notif.setPriority(Notification.PRIORITY_DEFAULT);
